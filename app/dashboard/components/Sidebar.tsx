          ...
          <ul className="mt-0 mb-[1em]">
            <li className="mb-[16px]">
              ...
              <ul className="border-b border-b-[#e6eaed] pb-[16px] block">
                <li className="mb-[4px]">
                  <Link href="/dashboard" className="flex items-center font-medium text-sm relative w-full p-[8px_12px] rounded-[5px] gap-2 bg-[#e6f0ff]">
                    <RxDashboard size={14} className="text-[#0076f9]" />
                    <span className="whitespace-nowrap text-sm text-[#0076f9]">Dashboard</span>
                  </Link>
                </li>
              </ul>
            </li>
